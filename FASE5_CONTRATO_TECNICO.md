...
🔄 Revisao de alinhamento: 2026-04-15
...
7. D7: API web aceita identificadores de valvula/slot em base 1 (1..N) e base 0 (0..N-1).
...
1. GET /api/status
2. GET /api/schedules
3. POST /api/valve/toggle
4. POST /api/valve/set
5. POST /api/valves/off-all
6. POST /api/schedule/save
7. POST /api/schedule/delete
8. POST /api/schedule/clear
9. POST /api/config/runtime
10. POST /api/rtc/set
...
9. API valida index/slot em base 1 e base 0.
